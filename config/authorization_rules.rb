 authorization do  
   role :admin do  
     has_permission_on [:welcome], :to => [:workflow,:user_management,:index,:admin_dashboard,:examiner_dashboard,:qsetter_dashboard,:examinee_dashboard,:confirm_registration,:reject_registration]     
     ...
     has_permission_on [:settings], :to => [:index, :update]
     ...
     has_permission_on [:assets], :to => [:index,:new,:edit,:create,:update,:destroy,:show,:get,:share,:lock,:unlock,:unshare]
     has_permission_on [:folders], :to => [:index,:new,:edit,:create,:update,:destroy,:getName,:browse,:share, :unshareFolder]
     has_permission_on [:article], :to => [:index,:list,:edit,:update,:new,:show,:save,:news,:getBlogcategory,:thumbsUp,:thumbsDown,:comment,:delete,:delete_comment,:destroy]
     has_permission_on [:blog_category], :to => [:index,:list,:edit,:update,:new,:show,:save,:blog,:subcategory,:subcategory_article,:categoryArticle]
     has_permission_on [:subcategory], :to => [:index,:list,:edit,:update,:new,:show,:save,:destroy]     
   end  
   
   role :examiner do
     has_permission_on [:welcome], :to => [:workflow,:user_management,:examiner_dashboard]
     ...
     has_permission_on [:assets], :to => [:index,:new,:edit,:create,:update,:destroy,:show,:get,:share,:lock,:unlock,:unshare]
     has_permission_on [:folders], :to => [:index,:new,:edit,:create,:update,:destroy,:getName,:browse,:share, :unshareFolder]
     has_permission_on [:article], :to => [:index,:list,:edit,:update,:new,:show,:save,:news,:getBlogcategory,:thumbsUp,:thumbsDown,:comment,:delete,:delete_comment]
     has_permission_on [:blog_category], :to => [:index,:list,:edit,:update,:new,:show,:save,:blog,:subcategory,:subcategory_article,:categoryArticle]
     has_permission_on [:subcategory], :to => [:index,:list,:edit,:update,:new,:show,:save]   
   end
   ...
   role :questionsetter do
     ...
     has_permission_on [:folders], :to => [:index,:new,:edit,:create,:update,:destroy,:getName,:browse,:share, :unshareFolder]
     has_permission_on [:article], :to => [:index,:list,:edit,:update,:new,:show,:save,:news,:getBlogcategory,:thumbsUp,:thumbsDown,:comment,:delete,:delete_comment]
     has_permission_on [:blog_category], :to => [:index,:blog,:subcategory,:subcategory_article,:categoryArticle]   
   end
   ...
   role :examinee do
     ...
     has_permission_on [:reports], :to => [:generateUser]
